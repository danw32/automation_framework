...
class SeleniumClass(driver_global.SeleniumTest):
    ...
    def test_selenium_code_lottery(self, url_val, username, password, first_number, second_number):
        try:
            ...
            # maybe try putting these numbers in the spreadsheet and concatenating the element id
            # self.driver.find_element_by_id("lottos-straight-17").click()
            ...
            # Green Place Bet button
            # //*[ @ id="straight"] / div[4] / div[2] / div[3] / a[3]

            # self.take_screenshot_now("irish_lottery_put_on")
